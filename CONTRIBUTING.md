Contributing to KSOC Core
============================

The KSOC Core project operates an open contributor model where anyone is
...
The following applies to code changes to the KSOC Core project, and is not to be
confused with overall KSOC Network Protocol consensus changes.

Whether a pull request is merged into KSOC Core rests with the project merge
...
Patches that change KSOC consensus rules are considerably more involved than
...
Where a patch set proposes to change the KSOC consensus, it must have been
...
The project leader is the release manager for each KSOC Core release.
