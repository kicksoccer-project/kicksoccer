...
This means one can have an always-on ksocd instance running, and another local kicksoccerd/kicksoccer-qt instance which connects to this node and receives blocks from it.
