...
In order to support loading of multiple wallets in kicksoccer-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kicksoccer.cpp.
...
Changes to kicksoccer.cpp
----------------------
kicksoccer.cpp is the entry point into kicksoccer-qt, and as such, will require some minor modifications to provide hooks for
