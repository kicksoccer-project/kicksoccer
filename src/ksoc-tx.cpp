...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ksoc Core kicksoccer-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  kicksoccer-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ksoc transaction") + "\n" +
                               "  kicksoccer-tx [options] -create [commands]   " + _("Create hex-encoded ksoc transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ksoc transaction
