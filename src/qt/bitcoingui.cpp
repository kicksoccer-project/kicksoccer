...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a KSOC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and ksoc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About KickSoccer Core"), this);
    aboutAction->setStatusTip(tr("Show information about KickSoccer Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KSOC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your KSOC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified KSOC addresses"));
    ...
    openAction->setStatusTip(tr("Open a KSOC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the KickSoccer Core help message to get a list with possible KSOC command-line options"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KSOC network", "", count));
}
