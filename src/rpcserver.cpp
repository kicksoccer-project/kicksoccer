...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ksoc features */
        {"ksoc", "masternode", &masternode, true, true, false},
        {"ksoc", "listmasternodes", &listmasternodes, true, true, false},
        {"ksoc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ksoc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ksoc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ksoc", "masternodedebug", &masternodedebug, true, true, false},
        {"ksoc", "startmasternode", &startmasternode, true, true, false},
        {"ksoc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ksoc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ksoc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ksoc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ksoc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ksoc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ksoc", "mnsync", &mnsync, true, true, false},
        {"ksoc", "spork", &spork, true, true, false},
        {"ksoc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"ksoc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use kicksoccerd, or the -server option to kicksoccer-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"KickSoccer Alert\" admin@foo.com\n"),
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:10556/\n";
}
